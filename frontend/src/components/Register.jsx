...
import './sign-in.css'; // Asegúrate de importar el CSS
import carrito from './img/supermarket.png'; // Asegúrate de importar la imagen
      ...
      <main className="form-signin w-100 m-auto">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-3 text-center">
            ...
            <Link to="/login" className="text-primary">Iniciar sesión</Link>
          </div>
        </form>
      </main>
